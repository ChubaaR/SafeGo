...
import 'emergency_contact_sign_up.dart';
import 'emergency_homepage.dart' as EmergencyHome;
import 'package:firebase_auth/firebase_auth.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class EmergencyContactSignIn extends StatefulWidget {
  const EmergencyContactSignIn({super.key});

  @override
  EmergencyContactSignInState createState() => EmergencyContactSignInState();
}

class EmergencyContactSignInState extends State<EmergencyContactSignIn> {
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          try {
                            ...
                            switch (e.code) {
                              case 'user-not-found':
                                errorMessage = 'No emergency contact account found with this email.';
                                break;
                              case 'invalid-email':
      ...
      try {
        ...
        switch (e.code) {
          ...
          case 'invalid-email':
            ...
            break;
          default:
            errorMessage = 'Emergency contact sign in failed. Please try again.';
        }
  ...
  void _signIn() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        try {
          await FirebaseFirestore.instance.collection('emergency_contacts')
        ...
        // On success, navigate to Emergency Contacts page
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => const EmergencyHome.HomePage()),
        );
        ...
        child: Form(
          ...
          child: ListView(
            ...
            TextButton(
              ...
              child: const Text(
                'Don\'t have an emergency contact account ? Sign Up',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.w600,
